    ...
    return <>
      <div className="w-full m-4 md:m-0">
        ...
        <div className="my-8">
          ...
          <div className="my-3 h-52 w-96 bg-primary-foreground rounded-xl bg-[url('/featured1.jpg')] bg-cover bg-top border hover:shadow-md hover:cursor-pointer overflow-hidden" >
            <div className="px-10 pb-5 hover:opacity-0 transition-all flex items-end bg-gradient-to-t from-slate-600 to-transparent bg-opacity-70 h-full w-full">
