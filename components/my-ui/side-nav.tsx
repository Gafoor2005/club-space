...
export default function SideNav() {
    ...
    return (
        <div className="hidden md:flex flex-col gap-2 h-full sticky top-24">
            <Button variant={pathname=='/'? "default":"secondary"} className="w-44 justify-start" onClick={()=> router.push('/')}>
